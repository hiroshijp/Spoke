...
export default class YukizemiPackSource extends BaseSource {
  constructor(editor) {
    super();
    const manifestUrl = "https://pub-4f0dedea679345d4bac7dfcf7b6aa95a.r2.dev/yukizemi-pack-manifest.json";
    this.editor = editor;
    this.id = manifestUrl;
    this.name = "Yukizemi Pack";
